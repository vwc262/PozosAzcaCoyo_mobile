...
func _ready() -> void:
	GlobalSignals.connect_on_go_perfil_particular(_on_mini_site_clicked, true)
	
func _exit_tree() -> void:
	GlobalSignals.connect_on_go_perfil_particular(_on_mini_site_clicked, true)

func _on_mini_site_clicked(_isParticular: bool, _id_estacion: int, _id_proyecto: int):
